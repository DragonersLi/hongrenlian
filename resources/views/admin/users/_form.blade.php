    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="form-control" type="text" name="username"  value="{{$username or ''}}" placeholder="昵称">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="layui-form-item">
                    <div class="layui-upload">
                        ...
                        {{--</button>--}}
                        <input type="hidden" name="avatar" id="avatar"  value="{{$avatar or ''}}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="form-control" type="text" name="mobile"  value="{{$mobile or ''}}" placeholder="手机号">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <input type="radio" name="sex" value="1" @if(isset($sex) && $sex == 1) checked @endif>
                <label for="radio_female">女</label>
                <input type="radio" name="sex" value="2" @if(isset($sex) && $sex == 2) checked @endif>
            </div>
        </div>
