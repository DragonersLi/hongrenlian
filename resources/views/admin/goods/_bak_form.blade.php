    ...
    <div class="col-md-6">
        ...
        <div class="text-center m-t-10">
            <button type="submit" class="btn layui-btn" id="">
            ...
            for(k in obj){
                for(s in obj1){
                    if(obj1[s].checked==true&&obj[k].checked==true){
                        ...
                        var add = add + '<input   type="text" class="form-control"   name="spec[guige]['+spec_id+'][]" size="12" placeholder="规格一" value="' + spec_value_name + '" style="width:80px;height:30px;display:inline;">&nbsp;';
                        var add = add + '<input   type="hidden" class="form-control"   name="spec[guige]['+spec_id+'][]" size="12"   value="' + spec_value_id + '">&nbsp;';
                        var add = add + '<input   type="text" class="form-control"   name="spec[guige]['+spec_id1+'][]" size="12" placeholder="规格二"  value="' + spec_value_name1 + '" style="width:80px;height:30px;display:inline;">&nbsp;';
                        var add = add + '<input   type="text" class="form-control"    name="spec[kc][]" size="12" placeholder="库存"  value="'+kucun+'" style="width:80px;height:30px;display:inline;">&nbsp;';
                        var add = add + '<input   type="text" class="form-control"    name="spec[jg][]" size="12"  placeholder="红人圈"  value="'+memprice+'"  style="width:80px;height:30px;display:inline;"/>&nbsp;';
